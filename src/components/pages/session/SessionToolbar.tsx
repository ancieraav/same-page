...
function renderIcon(action: string) {
  ...
  if (action === 'quote') {
    return (
      <>
        <path d="M3 21c3 0 7-1 7-8V5c0-1.25-.756-2.017-2-2H4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-2 2-2 2s-1 .008-1 1.031V20c0 1 0 1 1 1z" />
        <path d="M15 21c3 0 7-1 7-8V5c0-1.25-.757-2.017-2-2h-4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-2 2-2 2s-1 .008-1 1.031V20c0 1 0 1 1 1z" />
      </>
    );
  }
  return (
  ...
  return (
    <div className="editor-toolbar" role="toolbar" aria-label="Text formatting tools">
      <div className="toolbar-left-tools">
        ...
        <div className="toolbar-btn-group">
          {['bullet-list', 'quote', 'code'].map((action) => (
            <button
              key={action}
              type="button"
              className="toolbar-btn"
