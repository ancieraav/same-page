type SelectedParticipant = { name: string; initials: string; role: string; score: number };

export function ParticipantsPart8({ open, selected, onClose }: { open: boolean; selected: SelectedParticipant; onClose: () => void }) {
  return (
    <div className={`analytics-modal-backdrop${open ? ' is-active' : ''}`} id={"participant-analytics-modal"} role={"presentation"} aria-hidden={!open} onMouseDown={(event) => event.currentTarget === event.target && onClose()}>
        ...
        <div className={"modal-header-banner"}>
          <div className={"modal-profile-group"}>
            <div className={"room-avatar-circle"} id={"modal-participant-avatar"}>
              <span id={"modal-participant-initials"}>
                {selected.initials}
              </span>
            </div>
          ...
          <button type={"button"} className={"btn-modal-close"} id={"btn-close-participant-modal"} aria-label={"Close analytics popup"} title={"Close (Esc)"} onClick={onClose}>
        ...
        <div className={"modal-body-scrollable"} id={"modal-body-scrollable"}>
          ...
          <section className={"shared-hero-analytics-grid modal-hero-grid"} id={"modal-shared-hero-analytics"}>
            <div className={"hero-metric-card"} id={"modal-card-hero-overall"}>
              <div className={"hero-card-header"}>
                ...
                <span className={"hero-status-pill tone-positive"}>
                  Mostly aligned
                </span>
              </div>
                ...
                <div className={"hero-progress-group"}>
                  <div className={"curved-progress-container"}>
                    <svg className={"curved-progress-svg"} viewBox={"0 0 220 30"} fill={"none"} preserveAspectRatio={"none"}>
                      ...
                      <path className={"curved-track-fill"} id={"modal-overall-scurve-fill"} d={"M 10,15 C 28,4 42,4 60,15 C 78,26 92,26 110,15 C 128,4 142,4 160,15 C 178,26 192,26 210,15"} stroke={"url(#gradient-analytics-overall-popup)"} strokeWidth={"7"} strokeLinecap={"round"} pathLength={"100"} stroke-dasharray={"100"} stroke-dashoffset={"26"}></path>
                    </svg>
                  </div>
                ...
                <div className={"hero-progress-group"}>
                  <div className={"curved-progress-container"}>
                    <svg className={"curved-progress-svg"} viewBox={"0 0 220 30"} fill={"none"} preserveAspectRatio={"none"}>
                      ...
                      <path className={"curved-track-bg"} d={"M 10,15 C 28,4 42,4 60,15 C 78,26 92,26 110,15 C 128,4 142,4 160,15 C 178,26 192,26 210,15"} stroke={"#E2E8F0"} strokeWidth={"7"} strokeLinecap={"round"}></path>
                      <path className={"curved-track-fill"} id={"modal-participant-scurve-fill"} d={"M 10,15 C 28,4 42,4 60,15 C 78,26 92,26 110,15 C 128,4 142,4 160,15 C 178,26 192,26 210,15"} stroke={"url(#gradient-analytics-participant-popup)"} strokeWidth={"7"} strokeLinecap={"round"} pathLength={"100"} stroke-dasharray={"100"} stroke-dashoffset={"12"}></path>
                    </svg>
                  </div>
          ...
          <section className={"ai-summary-card"} id={"modal-ai-summary-card"}>
            <div className={"summary-card-header"}>
              ...
              <button type={"button"} className={"btn-toggle-summary"} id={"btn-toggle-modal-summary"} aria-expanded={"false"} title={"Toggle full summary"}>
                <span id={"toggle-modal-summary-label"}>
                  Read Full Summary
                </span>
                <svg className={"summary-chevron-icon"} id={"modal-summary-chevron"} width={"14"} height={"14"} viewBox={"0 0 24 24"} fill={"none"} stroke={"currentColor"} strokeWidth={"2.5"} strokeLinecap={"round"} strokeLinejoin={"round"}>
                  <polyline points={"6 9 12 15 18 9"}></polyline>
                </svg>
              </button>
            </div>
            <div className={"summary-body-content"}>
              <p className={"summary-preview-paragraph"} id={"modal-summary-preview"}></p>
              <div className={"summary-extended-drawer"} id={"modal-summary-drawer"}>
                <div className={"summary-extended-inner"} id={"modal-summary-extended"}></div>
              </div>
            </div>
          </section>
          <section className={"dynamic-combo-container"} id={"modal-dynamic-combo-container"} aria-live={"polite"}></section>
        </div>
        <div className={"modal-footer-bar"}>
          <span className={"modal-esc-hint"}>
            Press Esc or click outside to dismiss
          </span>
          <button type={"button"} className={"dock-btn-secondary"} id={"btn-footer-close-modal"} onClick={onClose}>
            Close
          </button>
        </div>
      </div>
