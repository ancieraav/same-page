export function ParticipantsPart6({ visibleIds, expanded, onToggle, onOpen }: { visibleIds: string[]; expanded: Set<number>; onToggle: (index: number) => void; onOpen: (id: string) => void }) {
  return (
    <div className={"team-list-stack"} id={"team-list-stack"}>
      <article className={"team-member-card is-clickable"} data-participant-id={"elena"} tabIndex={0} role={"button"} aria-label={"View Elena Rostova analytics"} style={{ display: visibleIds.includes('elena') ? undefined : 'none' }} onClick={() => onOpen('elena')}>
        ...
        <div className={"team-card-statement-col"}>
          <div className={"statement-expandable-wrap"}>
            ...
            <button type={"button"} className={`btn-read-more-statement${expanded.has(0) ? ' is-expanded' : ''}`} aria-expanded={expanded.has(0)} title={"Toggle full response"} onClick={(event) => { event.stopPropagation(); onToggle(0); }}>
              <span>
      ...
      <article className={"team-member-card is-self is-clickable"} data-participant-id={"you"} tabIndex={0} role={"button"} aria-label={"View your analytics"} style={{ display: visibleIds.includes('you') ? undefined : 'none' }} onClick={() => onOpen('you')}>
        <div className={"team-card-profile-col"}>
        ...
        <div className={"team-card-statement-col"}>
          <div className={"statement-expandable-wrap"}>
            ...
            <button type={"button"} className={`btn-read-more-statement${expanded.has(1) ? ' is-expanded' : ''}`} aria-expanded={expanded.has(1)} title={"Toggle full response"} onClick={(event) => { event.stopPropagation(); onToggle(1); }}>
              <span>
      ...
      <article className={"team-member-card is-clickable"} data-participant-id={"raka"} tabIndex={0} role={"button"} aria-label={"View Raka Pratama analytics"} style={{ display: visibleIds.includes('raka') ? undefined : "none" }} onClick={() => onOpen('raka')}>
        <div className={"team-card-profile-col"}>
        ...
        <div className={"team-card-statement-col"}>
          <div className={"statement-expandable-wrap"}>
            ...
            <button type={"button"} className={`btn-read-more-statement${expanded.has(2) ? ' is-expanded' : ''}`} aria-expanded={expanded.has(2)} title={"Toggle full response"} onClick={(event) => { event.stopPropagation(); onToggle(2); }}>
              <span>
      ...
      <article className={"team-member-card is-clickable"} data-participant-id={"david"} tabIndex={0} role={"button"} aria-label={"View David Chen analytics"} style={{ display: visibleIds.includes('david') ? undefined : "none" }} onClick={() => onOpen('david')}>
        <div className={"team-card-profile-col"}>
        ...
        <div className={"team-card-statement-col"}>
          <div className={"statement-expandable-wrap"}>
            ...
            <button type={"button"} className={`btn-read-more-statement${expanded.has(3) ? ' is-expanded' : ''}`} aria-expanded={expanded.has(3)} title={"Toggle full response"} onClick={(event) => { event.stopPropagation(); onToggle(3); }}>
              <span>
      ...
      <article className={"team-member-card is-clickable"} data-participant-id={"sarah"} tabIndex={0} role={"button"} aria-label={"View Sarah Jenkins analytics"} style={{ display: visibleIds.includes('sarah') ? undefined : "none" }} onClick={() => onOpen('sarah')}>
        <div className={"team-card-profile-col"}>
        ...
        <div className={"team-card-statement-col"}>
          <div className={"statement-expandable-wrap"}>
            ...
            <button type={"button"} className={`btn-read-more-statement${expanded.has(4) ? ' is-expanded' : ''}`} aria-expanded={expanded.has(4)} title={"Toggle full response"} onClick={(event) => { event.stopPropagation(); onToggle(4); }}>
              <span>
