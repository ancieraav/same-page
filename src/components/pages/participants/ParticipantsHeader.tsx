  ...
  return (
    <header className="minimal-header">
      ...
      <div className="header-nav">
        <div className="header-participants-badge" id="header-participants-badge" title="Active participants count">
          <svg
            width="14"
            height="14"
            viewBox="0 0 24 24"
          ...
          <span id="header-participants-count">5 Participants</span>
        </div>
