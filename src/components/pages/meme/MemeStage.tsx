  ...
  return (
    <main className="meme-canvas-wrapper" id="meme-canvas-wrapper">
      <div className="question-round-indicator">
        ...
        <span>Intermission &bull; Room Reset</span>
      </div>
      ...
      <div className="meme-gif-display">
        <Image
          className="meme-gif-image"
          id="meme-gif-image"
          src="https://media.giphy.com/media/bLzSbiS3Lzkrwl6ENS/giphy.gif"
          alt="Sarah Jenkins waiting meme"
          width={640}
          height={360}
          priority
          unoptimized
      ...
      <div className="meme-actions-container">
        <button
          type="button"
          className="btn-force-next-question"
          id="btn-force-next"
          onClick={onNext}
          disabled={busy}
        >
          ...
          <span className="btn-text-label">Next question</span>
          <svg
