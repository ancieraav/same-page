...
import { MemePart1 } from './MemePart1';
import { MemePart2 } from './MemePart2';
...
export function MemePage() {
  ...
  useEffect(() => {
    ...
    return () => { window.clearInterval(tick); window.clearInterval(elapsed); };
  }, []);
  ...
  return <><MemePart1 duration={time} /><MemePart2 countdown={countdown} onNext={goNext} busy={busy} /></>;
}
